-- Справочник наночастиц (dim_nanoparticle).
-- Каждая строка — уникальная комбинация состава, формы, покрытия и размера наночастицы.
-- В справочник также добавлены дополнительные характеристики из экспериментов (например, потенциал, метод синтеза и др.).
